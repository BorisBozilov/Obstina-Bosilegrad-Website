...
public partial class sr_Galerija : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT ID,Slika,Opis FROM Galerija WHERE (jezik_id='sr') ORDER BY ID DESC", cn);
