...
public partial class sr_Vesti : System.Web.UI.Page

{
    ...
    private void LoadData()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT ID,Nadnaslov,Naslov,Podnaslov,Tekst,Slika,Opis FROM Vesti WHERE (jezik_id='sr') ORDER BY ID DESC", cn);
