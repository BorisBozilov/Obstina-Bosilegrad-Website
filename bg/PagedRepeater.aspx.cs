...
public partial class bg_PagedRepeater : System.Web.UI.Page

{
   ...
   private void LoadData()
   {
      ...
      SqlDataAdapter da = new SqlDataAdapter("SELECT ID,Nadnaslov,Naslov,Podnaslov,Tekst,Slika,Opis FROM articles WHERE (jezik_id='bg') ORDER BY ID DESC", cn);
